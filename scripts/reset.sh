...
psql -h 127.0.0.1 -d mctrot --command "drop table if exists raw_phonebook_listing cascade;"
psql -h 127.0.0.1 -d mctrot --command "drop table if exists park_feature cascade;"
